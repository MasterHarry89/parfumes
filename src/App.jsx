...
function App() {
  ...
  const content = path === '/kosik' ? renderCart() : path === '/kolekce' || path === '/znacky' ? renderCatalog() : path.startsWith('/produkt/') ? renderProduct() : <Home onOpen={(id) => navigate(`/produkt/${id}`)} onShop={() => navigate('/kolekce')} />
